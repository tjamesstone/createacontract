            ...
            <div className="contractpreview">
                <div className="actualcontract">
                    <header>
                        ...
                        <h6>Service Agreement Between {this.props.company.legal_name} and {this.props.client.client_name}</h6>
                        <p>Prepared on {month}/{day}/{year} for {this.props.client.signatory}</p>
                    </header>
                    ...
                    <div className="offeredservice">
                        ...
                        <h5>Price: {this.props.features.price} per month</h5>
                        <h6>Will be paid by {this.props.client.client_name} on a {this.props.terms.payment_frequency} basis</h6>
                    </div>
                    <div className="theterms">
                        <h4>Effective Date: {this.props.terms.effective_date}</h4>
                        <h4>Term: {this.props.terms.contract_length} months. {this.props.terms.autorenew === 'yes' ? <p>This License Agreement will automatically renew every {this.props.terms.contract_length} months unless written notice of cancellation is
received at least 60 days prior to the end of the current term.</p> : <p>At the end of this initial term of {this.props.terms.contract_length} months, this contract will not auto-renew.</p> }</h4>
                        {/* {this.props.terms.autorenew !== 'yes' ?
                            <div>Hello world</div>
                            :
                            <div>At the end of this contract, it will not auto-renew</div>
                        } */}
...
unless otherwise specified by {this.props.company.company_name}</h4>
                        ...
                        <h4>Tax Compliance: All fees charged hereunder are exclusive of any value added tax (VAT), sales tax, consumption tax, or any other similar tax. In addition to the fees payable hereunder, {this.props.company.company_name} reserves the right to charge to the {this.props.client.client_name} any applicable sales, consumption, VAT, or similar taxes imposed by any federal, state, or local government authority upon the services rendered or any deliverables provided hereunder, other than any taxes based upon {this.props.company.legal_name}’s income or payroll.</h4>
                        {this.props.terms.autorenew === 'yes' ?
